...
(deftest add-sheet!-test
  ...
  actual   (add-sheet! workbook sheet-name)]
    ...
    (testing "Should fail on non-Workbook"
      (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (add-sheet! "not-a-workbook" "sheet-name"))))))
...
(deftest add-row!-test
  (testing "Should fail on invalid parameter types."
    (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (add-row! "not-a-sheet" [1 2 3])))))

(deftest add-rows!-test
  (testing "Should fail on invalid parameter types."
    (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (add-rows! "not-a-sheet" [[1 2 3]])))))
...
(deftest remove-row!-test
  ...
  first-row (first (row-seq sheet))]
    (testing "Should fail on invalid parameter types."
      (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (remove-row! "not-a-sheet" (first (row-seq sheet)))))
      (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (remove-row! sheet "not-a-row"))))
...
(deftest remove-all-row!-test
  ...
  (is (= 0 (.getPhysicalNumberOfRows sheet)))))
    (testing "Should fail on invalid parameter types."
      (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (remove-all-rows! "not-a-sheet"))))))
...
(deftest sheet-seq-test
  ...
  (is (= [sheet2 sheet3] (rest actual)))))
    (testing "Should fail on invalid type"
      (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (sheet-seq "not-a-workbook"))))))
...
(deftest sheet-name-test
  ...
  (testing "Should fail on invalid parameter type"
    (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (sheet-name "not-a-sheet")))))
...
(deftest select-sheet-test
  ...
  (testing "Should fail on invalid parameter type"
    (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (select-sheet "name" "not-a-workbook")))))
...
(deftest select-columns-test
  ...
  (are [actual expected] (= actual (let [[a b c d] expected]
    ...
    (testing "Should fail on invalid parameter types."
      (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (select-columns {:A :first, :B :second} "not-a-worksheet"))))))

(deftest row-seq-test
  (testing "Should fail on invalid parameter types."
    (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (row-seq "not-a-sheet")))))

(deftest save-workbook!-test
  (testing "Should fail on invalid parameter types."
    (is (thrown-with-msg? ClassCastException #"^java.lang.String.*" (save-workbook! "filename.xlsx" "not-a-workbook")))))
...
(deftest create-font!-test
  ...
  (let [f-default (create-font! wb {})
    ...
    (is (= Font/BOLDWEIGHT_BOLD (.getBoldweight f-bold)))))
      (is (thrown-with-msg? ClassCastException #"^java.lang.String.*"
